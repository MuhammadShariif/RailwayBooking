...
namespace RailwayBooking.Controllers
{
    public class TrainsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Train_ID,TrainName,LocationStart,LocationEnd")] Train train)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Train_ID,TrainName,LocationStart,LocationEnd")] Train train)
        {
            if (ModelState.IsValid)
            {
